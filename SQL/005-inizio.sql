-- Benedetto Evangelista 29/09/2025 12:53  
...
INSERT INTO regioni (id, nome, latitudine, longitudine) VALUES (2,'Valle d''Aosta/Vallée d''Aoste',45.737222,7.320556);
...
insert into regioni values (21,'Repubblica di siena',0,0);
UPDATE regioni SET Nome='Repubblica di Toscana' 
where id = 21;
commit;

begin transaction;
  delete from regioni where id = 21;
--select count(*) from regioni;
